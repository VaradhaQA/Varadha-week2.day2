...
public class DuplicateLead {
	...
	public static void main(String[] args) {
        ...
        WebElement deleteCompanyNameElement = driver.findElement(By.id("createLeadForm_companyName"));
        deleteCompanyNameElement.clear();
        
        WebElement deleteFirstNameElement = driver.findElement(By.id("createLeadForm_firstName"));
        deleteFirstNameElement.clear();
